...
ARG BASE_IMAGE
ARG BASE_IMAGE_AMD64=${BASE_IMAGE}
ARG BASE_IMAGE_ARM64=${BASE_IMAGE}

FROM ${BASE_IMAGE_AMD64} AS base-amd64
ARG BASE_IMAGE_AMD64
ARG BASE_IMAGE=${BASE_IMAGE_AMD64}
ARG CUDA_AMD64
ARG EXPECTED_CUDA_VERSION=${CUDA_AMD64}

FROM ${BASE_IMAGE_ARM64} AS base-arm64
ARG BASE_IMAGE_ARM64
ARG BASE_IMAGE=${BASE_IMAGE_ARM64}
ARG CUDA_ARM64
ARG EXPECTED_CUDA_VERSION=${CUDA_ARM64}

# BuildKit selects the platform-specific base before installing ROS.
